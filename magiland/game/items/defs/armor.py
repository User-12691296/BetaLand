...
MaceArmor("crystal_armor", "crystal_armor", 0, 2, 10, amount_of_projectiles=8, laser=PROJECTILE_CLASSES.CrystalMaceProj).addToGroup(ARMORS)
Armor("arctic_armor", "arctic_armor", 0, 2.4, 10).addToGroup(ARMORS)
MaceArmor("deepdark_armor", "deepdark_armor", 0, 2.6, 10, amount_of_projectiles=8, laser=PROJECTILE_CLASSES.DarknessMaceProj, cooldown=0).addToGroup(ARMORS)
MaceArmor("dragon_hide", "dragon_hide", 0, 3, 10, amount_of_projectiles=8, laser=PROJECTILE_CLASSES.MoltenMaceProj).addToGroup(ARMORS)