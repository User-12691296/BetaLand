...
Armor("arctic_armor", "arctic_armor", 0, 4.2, 10).addToGroup(ARMORS)
MaceArmor("deepdark_armor", "deepdark_armor", 0, 4.4, 10, 300, 8, PROJECTILE_CLASSES.DarknessMaceProj).addToGroup(ARMORS)
MaceArmor("dragon_hide", "dragon_hide", 0, 4.5, 10, 300, 8, PROJECTILE_CLASSES.MoltenMaceProj).addToGroup(ARMORS)
