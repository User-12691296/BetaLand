...
SIGWEAPONS = []
SigWeapon("clawofcrabking", "clawofcrabking", 35, 2, 360, cooldown=20).addToGroup(SIGWEAPONS)
SigWeapon("clawofsnakequeen", "clawnofsnakequeen", 35, 2, 360, cooldown=20).addToGroup(SIGWEAPONS)
