...
C_PATH = ctypes.util.find_library("./fovcalc")
if not C_PATH:
    print("Unable to find FOVCALC.")

try:
    C_FOV_CALC_LIB = ctypes.CDLL(C_PATH)
except OSError as err:
    print("Unable to load FOVCALC: ", err)

C_FOV_CALC = C_FOV_CALC_LIB.calcFOV
C_FOV_CALC.restype = None
#int ox, int oy, const bool* obstacles, int max_width, int max_height, bool* shown_tiles
C_FOV_CALC.argtypes = [ctypes.c_int,
                       ctypes.c_int,
